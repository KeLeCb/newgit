...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="../user/index.jsp">YT数码</a></div>
        <div class="left_open">
 ...
 -->        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a href="admin-list.jsp" >个人信息</a></dd>
              <dd><a href="login.jsp" >切换帐号</a></dd>
              <dd><a href="login.jsp">退出</a></dd>
            </dl>
          </li>
          <li class="layui-nav-item to-index"><a href="../user/index.jsp">前台首页</a></li>
        </ul>
    ...
    <!-- 底部开始 -->
    <div class="footer">
        <div class="copyright">YT数码欢迎您！</div>  
    </div>
    <!-- 底部结束 -->
</body>
</html>